window.QUIZ_DATA = {
 "vocab": [
  {
   "prompt": "Has ___ seen my keys? I can't find them anywhere.",
   "options": [
    "anyone",
    "any one"
   ],
 ...
 "proverbs": [
  {
   "prompt": "Necessity is the mother of invention.",
   "options": [
  ...
  },
  {
   ...
   "options": [
    "Time is a valuable resource, just like money.",
  ...
  },
  {
   ...
   "options": [
    "It's better to stop a problem before it happens.",
    "Things gained without effort are often lost just as easily.",
  ...
  },
  {
   ...
   "options": [
    ...
    "Accept criticism that genuinely applies to you.",
    "Different experiences make life more interesting.",
    "Don't risk everything on a single plan."
   ],
   "correctIndex": 1
  },
  {
   ...
   "options": [
    "Even hard times bring something good.",
    "Nothing pleasant lasts forever.",
  ...
  },
  {
   ...
   "options": [
    "Sometimes it's best to say nothing at all.",
    "It's wiser to be cautious than to regret it later.",
    "Home is the most comfortable place there is.",
    "Doing something late is better than not doing it at all."
   ],
   "correctIndex": 1
